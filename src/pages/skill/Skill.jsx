        ...
        <SkillSet>
          ...
          <SkillList color={"#FFF67E"}>
            <div>
              <h4>NodeJS</h4>
              <p>
                I possess an intermediate skill level in Node.js and have
                utilized it in numerous projects, including my most recent ones.
              </p>
            </div>
            <figure>
          ...
          <SkillList color={"#74E291"}>
            <div>
              <h4>MongoDB</h4>
              <p>
                I possess an intermediate level of proficiency in MongoDB
                database management, which I have utilized in my recent
                projects. Additionally, I am actively deepening my understanding
          ...
          <SkillList color={"#C6A969"}>
            <div>
              ...
              <p>
                ...
                experience in ReactJS and am actively involved in projects
                within my current organization. Furthermore, I have a solid
                understanding of the latest web technologies, server-based
                configurations, and computer hardware. I am also engaged in
                learning about the latest advancements in AI technologies and
                data science.
              </p>
            </div>
            <figure>
